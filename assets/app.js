(() => {
  const GAS_URL = "https://script.google.com/macros/s/AKfycbyObT_BWxrhzF2LxIlggfeN6_SvIudT1unYlfCcT3IYJeTSga05IupWc9_OgZPYy2S4/exec";
  const STORAGE_KEYS = {
    lessons: "thepsathit_lessons_v1",
    feedback: "thepsathit_feedback_v1",
    liked: "thepsathit_liked_lessons_v1"
  };
  const LOGO_URL = "https://img2.pic.in.th/a986af70f1d95baee0e9c664522b45e8.png";

  const defaultLessons = [
    {
      id: "starter-1",
      title: "ชุดการเรียนรู้สำหรับผู้เรียน กศน. อำเภอเทพสถิต",
